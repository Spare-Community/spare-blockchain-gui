...
import { AlertDialog, Fee, Back, ButtonLoading, Card, Flex, Form, TextField } from '@spare/core';
import { Box, Grid } from '@material-ui/core';
import { useDispatch } from 'react-redux';
import { useForm } from 'react-hook-form';
import { useNavigate } from 'react-router';
import { create_cc_for_colour_action } from '../../../modules/message';
import { chiaToMojo } from '@spare/core';
      ...
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          {asteroid 
            ...
            : <Trans>Create Spare Asset Token Wallet from Existing TAIL</Trans>}
